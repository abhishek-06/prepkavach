...
window.SUBJECTS = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        name: "Economy",
        topics: [
          { id: "eco-intro", name: "Introduction to Economics", group: "Basics" },
          { id: "eco-planning", name: "Economic Planning in India", group: "Basics" },
          { id: "eco-national-income", name: "National Income & GDP Aggregates", group: "Basics" },
          { id: "eco-demography", name: "Demography & Census Basics", group: "Basics" },
          { id: "eco-inflation", name: "Inflation, WPI, CPI and Core Concepts", group: "Basics" },
          { id: "eco-terminology", name: "Economy Terminology Quick Revision", group: "Basics" },

          { id: "eco-agriculture", name: "Agriculture, MSP & Food Security", group: "Sectors & Development" },
          { id: "eco-infrastructure", name: "Infrastructure and Energy", group: "Sectors & Development" },
          { id: "eco-industry", name: "Industry, MSME & Industrial Policy", group: "Sectors & Development" },
          { id: "eco-public-sector", name: "Public Sector Enterprises & Disinvestment", group: "Sectors & Development" },
          { id: "eco-poverty-unemployment", name: "Poverty and Unemployment", group: "Sectors & Development" },
          { id: "eco-schemes", name: "Major Economic Schemes and Programmes", group: "Sectors & Development" },

          { id: "eco-banking", name: "Banking System and Financial Inclusion", group: "Money, Banking & Finance" },
          { id: "eco-monetary-policy", name: "RBI and Monetary Policy", group: "Money, Banking & Finance" },
          { id: "eco-financial-system", name: "Financial System, Markets and Regulators", group: "Money, Banking & Finance" },
          { id: "eco-insurance", name: "Insurance and Social Security", group: "Money, Banking & Finance" },
          { id: "eco-fiscal-system", name: "Indian Fiscal System and Budget", group: "Money, Banking & Finance" },
          { id: "eco-fiscal-terms", name: "Key Fiscal and Economic Terms", group: "Money, Banking & Finance" },
          { id: "eco-taxation", name: "Taxation, GST and Cesses", group: "Money, Banking & Finance" },

          { id: "eco-international-orgs", name: "International Financial Organisations", group: "External & Reports" },
          { id: "eco-trade-commerce", name: "Trade, Commerce, BoP and Forex", group: "External & Reports" },
          { id: "eco-indices-reports", name: "Indices & Reports (HDI, GHI, EPI, etc.)", group: "External & Reports" },
          { id: "eco-digital-economy", name: "Digital Economy (UPI, CBDC, ONDC)", group: "External & Reports" }
        ]
      },
      {
        id: "science",
