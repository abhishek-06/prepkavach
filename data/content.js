    ...
    sections: [
      {
        ...
        name: "Maths",
        topics: [
          { id: "math-intro", name: "How to Use This Section", group: "Quant (Tier-1)" },
          { id: "math-number-system", name: "Number System", group: "Quant (Tier-1)" },
          { id: "math-simplification", name: "Simplification (BODMAS)", group: "Quant (Tier-1)" },
          { id: "math-fraction-decimal", name: "Fractions & Decimals", group: "Quant (Tier-1)" },
          { id: "math-surds-indices", name: "Surds & Indices", group: "Quant (Tier-1)" },
          { id: "math-square-cube-root", name: "Square Root & Cube Root", group: "Quant (Tier-1)" },
          { id: "math-hcf-lcm", name: "HCF & LCM", group: "Quant (Tier-1)" },
          { id: "math-percentage", name: "Percentage", group: "Quant (Tier-1)" },
          { id: "math-profit-loss", name: "Profit & Loss", group: "Quant (Tier-1)" },
          { id: "math-discount", name: "Discount", group: "Quant (Tier-1)" },
          { id: "math-average", name: "Average", group: "Quant (Tier-1)" },
          { id: "math-age", name: "Problems on Ages", group: "Quant (Tier-1)" },
          { id: "math-ratio-proportion", name: "Ratio & Proportion", group: "Quant (Tier-1)" },
          { id: "math-race", name: "Races", group: "Quant (Tier-1)" },
          { id: "math-mixture", name: "Mixture & Alligation", group: "Quant (Tier-1)" },
          { id: "math-partnership", name: "Partnership", group: "Quant (Tier-1)" },
          { id: "math-si", name: "Simple Interest", group: "Quant (Tier-1)" },
          { id: "math-ci", name: "Compound Interest", group: "Quant (Tier-1)" },
          { id: "math-time-work", name: "Time & Work", group: "Quant (Tier-1)" },
          { id: "math-pipe-cistern", name: "Pipes & Cisterns", group: "Quant (Tier-1)" },
          { id: "math-time-distance", name: "Time, Speed & Distance", group: "Quant (Tier-1)" },
          { id: "math-train", name: "Problems on Trains", group: "Quant (Tier-1)" },
          { id: "math-boat-stream", name: "Boats & Streams", group: "Quant (Tier-1)" },
          { id: "math-sequence-series", name: "Sequences & Series", group: "Quant (Tier-1)" },
          { id: "math-di", name: "Data Interpretation", group: "Quant (Tier-1)" },
          { id: "math-algebra", name: "Algebra", group: "Advance Maths (Tier-2)" },
          { id: "math-trigonometry", name: "Trigonometry", group: "Advance Maths (Tier-2)" },
          { id: "math-height-distance", name: "Height & Distance", group: "Advance Maths (Tier-2)" },
          { id: "math-mensuration", name: "Mensuration (2D & 3D)", group: "Advance Maths (Tier-2)" },
          { id: "math-geometry", name: "Geometry", group: "Advance Maths (Tier-2)" },
          { id: "math-coord-geometry", name: "Coordinate Geometry", group: "Advance Maths (Tier-2)" },
          { id: "math-permutation-combination", name: "Permutation & Combination", group: "Advance Maths (Tier-2)" },
          { id: "math-probability", name: "Probability", group: "Advance Maths (Tier-2)" },
          { id: "math-statistics", name: "Statistics", group: "Advance Maths (Tier-2)" }
        ]
      }
    ]
  },
