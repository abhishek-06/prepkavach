...
window.SUBJECTS = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        name: "Economy",
        topics: [
          { id: "eco-basics", name: "Basics: GDP, GNP, NI & Inflation", group: "Macroeconomics" },
          { id: "eco-planning", name: "Planning Commission & Five-Year Plans", group: "Planning" },
          { id: "eco-niti", name: "NITI Aayog", group: "Planning" },
          { id: "eco-budget", name: "Budget, Fiscal Policy & Deficits", group: "Public Finance" },
          { id: "eco-tax", name: "Taxation: Direct, Indirect & GST", group: "Public Finance" },
          { id: "eco-banking", name: "RBI & Banking System", group: "Money & Banking" },
          { id: "eco-money-mkt", name: "Money Market & Capital Market", group: "Money & Banking" },
          { id: "eco-agriculture", name: "Indian Agriculture: Revolutions & Schemes", group: "Sectors" },
          { id: "eco-industry", name: "Industry & Industrial Policy", group: "Sectors" },
          { id: "eco-poverty", name: "Poverty, Unemployment & Schemes", group: "Development" },
          { id: "eco-international", name: "Foreign Trade, BoP & Forex", group: "International Economy" },
          { id: "eco-orgs", name: "International Organizations (IMF, WB, WTO)", group: "International Economy" }
        ]
      },
      {
        id: "science",
