...
(function () {
  ...
  T["eng-antonyms"] = {
    body: `
      ...
      <h3>🔥 Extended Antonym Pairs — Advanced SSC List</h3>
      <table>
        <tr><th>Word</th><th>Antonym</th></tr>
        <tr><td>Abate</td><td>Increase / Intensify</td></tr>
        <tr><td>Abhor</td><td>Adore / Love</td></tr>
        <tr><td>Abolish</td><td>Establish / Create</td></tr>
        <tr><td>Abrupt</td><td>Gradual / Smooth</td></tr>
        <tr><td>Absurd</td><td>Logical / Sensible</td></tr>
        <tr><td>Accept</td><td>Reject / Decline</td></tr>
        <tr><td>Accidental</td><td>Intentional / Deliberate</td></tr>
        <tr><td>Acclaim</td><td>Criticism / Condemnation</td></tr>
        <tr><td>Accord</td><td>Discord / Disagreement</td></tr>
        <tr><td>Acquire</td><td>Forfeit / Lose</td></tr>
        <tr><td>Active</td><td>Passive / Dormant</td></tr>
        <tr><td>Acute</td><td>Mild / Dull</td></tr>
        <tr><td>Adjacent</td><td>Distant / Far</td></tr>
        <tr><td>Admire</td><td>Despise / Detest</td></tr>
        <tr><td>Admit</td><td>Deny / Refuse</td></tr>
        <tr><td>Adore</td><td>Hate / Detest</td></tr>
        <tr><td>Adversity</td><td>Prosperity / Fortune</td></tr>
        <tr><td>Aggravate</td><td>Alleviate / Soothe</td></tr>
        <tr><td>Agile</td><td>Sluggish / Awkward</td></tr>
        <tr><td>Allow</td><td>Forbid / Prohibit</td></tr>
        <tr><td>Aloof</td><td>Friendly / Sociable</td></tr>
        <tr><td>Ambitious</td><td>Unambitious / Lazy</td></tr>
        <tr><td>Ample</td><td>Insufficient / Scant</td></tr>
        <tr><td>Ancient</td><td>Modern / Recent</td></tr>
        <tr><td>Annoy</td><td>Please / Soothe</td></tr>
        <tr><td>Apex</td><td>Nadir / Bottom</td></tr>
        <tr><td>Apparent</td><td>Hidden / Obscure</td></tr>
        <tr><td>Appropriate</td><td>Inappropriate / Unsuitable</td></tr>
        <tr><td>Approve</td><td>Disapprove / Reject</td></tr>
        <tr><td>Arrogant</td><td>Humble / Modest</td></tr>
        <tr><td>Artificial</td><td>Natural / Genuine</td></tr>
        <tr><td>Ascend</td><td>Descend / Drop</td></tr>
        <tr><td>Assemble</td><td>Disperse / Scatter</td></tr>
        <tr><td>Assent</td><td>Dissent / Disagree</td></tr>
        <tr><td>Asset</td><td>Liability</td></tr>
        <tr><td>Astute</td><td>Naive / Foolish</td></tr>
        <tr><td>Attentive</td><td>Inattentive / Distracted</td></tr>
        <tr><td>Attract</td><td>Repel / Repulse</td></tr>
        <tr><td>Audacious</td><td>Cowardly / Timid</td></tr>
        <tr><td>Augment</td><td>Decrease / Reduce</td></tr>
        <tr><td>Authentic</td><td>Fake / Spurious</td></tr>
        <tr><td>Banal</td><td>Original / Fresh</td></tr>
        <tr><td>Barbarous</td><td>Civilized / Cultured</td></tr>
        <tr><td>Barren</td><td>Fertile / Productive</td></tr>
        <tr><td>Belittle</td><td>Praise / Extol</td></tr>
        <tr><td>Benevolent</td><td>Malevolent / Cruel</td></tr>
        <tr><td>Benign</td><td>Malignant / Harmful</td></tr>
        <tr><td>Bewildered</td><td>Clear / Composed</td></tr>
        <tr><td>Blatant</td><td>Subtle / Discreet</td></tr>
        <tr><td>Bleak</td><td>Bright / Cheerful</td></tr>
        <tr><td>Blend</td><td>Separate / Divide</td></tr>
        <tr><td>Blessing</td><td>Curse / Misfortune</td></tr>
        <tr><td>Blunder</td><td>Achievement / Success</td></tr>
        <tr><td>Blunt</td><td>Sharp / Pointed</td></tr>
        <tr><td>Bold</td><td>Cowardly / Timid</td></tr>
        <tr><td>Boost</td><td>Hinder / Demote</td></tr>
        <tr><td>Boredom</td><td>Excitement / Interest</td></tr>
        <tr><td>Bountiful</td><td>Scarce / Meager</td></tr>
        <tr><td>Brittle</td><td>Flexible / Tough</td></tr>
        <tr><td>Brusque</td><td>Polite / Courteous</td></tr>
        <tr><td>Bulky</td><td>Slim / Compact</td></tr>
        <tr><td>Bustling</td><td>Quiet / Calm</td></tr>
        <tr><td>Cacophony</td><td>Harmony / Melody</td></tr>
        <tr><td>Calamity</td><td>Blessing / Boon</td></tr>
        <tr><td>Callow</td><td>Mature / Experienced</td></tr>
        <tr><td>Candid</td><td>Deceitful / Insincere</td></tr>
        <tr><td>Capable</td><td>Incapable / Inept</td></tr>
        <tr><td>Captive</td><td>Free / Liberated</td></tr>
        <tr><td>Cautious</td><td>Reckless / Careless</td></tr>
        <tr><td>Cease</td><td>Begin / Continue</td></tr>
        <tr><td>Celebrate</td><td>Mourn / Lament</td></tr>
        <tr><td>Censor</td><td>Permit / Allow</td></tr>
        <tr><td>Cease</td><td>Continue / Resume</td></tr>
        <tr><td>Chaotic</td><td>Orderly / Organized</td></tr>
        <tr><td>Charitable</td><td>Stingy / Selfish</td></tr>
        <tr><td>Chastise</td><td>Reward / Praise</td></tr>
        <tr><td>Cherish</td><td>Neglect / Reject</td></tr>
        <tr><td>Chronic</td><td>Acute / Temporary</td></tr>
        <tr><td>Civilized</td><td>Barbaric / Savage</td></tr>
        <tr><td>Cleanse</td><td>Pollute / Sully</td></tr>
        <tr><td>Cogent</td><td>Unconvincing / Weak</td></tr>
        <tr><td>Coherent</td><td>Incoherent / Confused</td></tr>
        <tr><td>Coincide</td><td>Differ / Diverge</td></tr>
        <tr><td>Collect</td><td>Distribute / Disperse</td></tr>
        <tr><td>Combine</td><td>Separate / Divide</td></tr>
        <tr><td>Commence</td><td>End / Finish</td></tr>
        <tr><td>Commend</td><td>Censure / Reproach</td></tr>
        <tr><td>Compatible</td><td>Incompatible / Discordant</td></tr>
        <tr><td>Compel</td><td>Persuade gently / Coax</td></tr>
        <tr><td>Competent</td><td>Incompetent / Unable</td></tr>
        <tr><td>Complacent</td><td>Concerned / Dissatisfied</td></tr>
        <tr><td>Complex</td><td>Simple / Easy</td></tr>
        <tr><td>Complimentary</td><td>Insulting / Critical</td></tr>
        <tr><td>Compulsory</td><td>Optional / Voluntary</td></tr>
        <tr><td>Conceal</td><td>Reveal / Expose</td></tr>
        <tr><td>Concise</td><td>Verbose / Wordy</td></tr>
        <tr><td>Concur</td><td>Differ / Disagree</td></tr>
        <tr><td>Condense</td><td>Expand / Enlarge</td></tr>
        <tr><td>Confess</td><td>Deny / Conceal</td></tr>
        <tr><td>Confine</td><td>Release / Liberate</td></tr>
        <tr><td>Conform</td><td>Differ / Rebel</td></tr>
        <tr><td>Conscious</td><td>Unconscious / Unaware</td></tr>
        <tr><td>Conservative</td><td>Liberal / Progressive</td></tr>
        <tr><td>Conspicuous</td><td>Inconspicuous / Unnoticeable</td></tr>
        <tr><td>Constant</td><td>Variable / Inconsistent</td></tr>
        <tr><td>Contempt</td><td>Respect / Admiration</td></tr>
        <tr><td>Contented</td><td>Discontented / Dissatisfied</td></tr>
        <tr><td>Contract</td><td>Expand / Stretch</td></tr>
        <tr><td>Contrary</td><td>Same / Agreeing</td></tr>
        <tr><td>Convergent</td><td>Divergent / Separate</td></tr>
        <tr><td>Corpulent</td><td>Thin / Lean</td></tr>
        <tr><td>Corrupt</td><td>Honest / Upright</td></tr>
        <tr><td>Counterfeit</td><td>Genuine / Authentic</td></tr>
        <tr><td>Courteous</td><td>Rude / Impolite</td></tr>
        <tr><td>Cowardly</td><td>Brave / Courageous</td></tr>
        <tr><td>Credible</td><td>Incredible / Doubtful</td></tr>
        <tr><td>Crude</td><td>Refined / Polished</td></tr>
        <tr><td>Curtail</td><td>Lengthen / Extend</td></tr>
        <tr><td>Cynical</td><td>Optimistic / Trusting</td></tr>
        <tr><td>Daring</td><td>Cautious / Timid</td></tr>
        <tr><td>Dauntless</td><td>Cowardly / Fearful</td></tr>
        <tr><td>Dearth</td><td>Abundance / Plenty</td></tr>
        <tr><td>Decadent</td><td>Wholesome / Healthy</td></tr>
        <tr><td>Deceive</td><td>Be honest / Tell truth</td></tr>
        <tr><td>Decisive</td><td>Indecisive / Hesitant</td></tr>
        <tr><td>Decline</td><td>Accept / Improve</td></tr>
        <tr><td>Deepen</td><td>Shallow / Reduce</td></tr>
        <tr><td>Defame</td><td>Praise / Extol</td></tr>
        <tr><td>Defeat</td><td>Victory / Win</td></tr>
        <tr><td>Defective</td><td>Perfect / Flawless</td></tr>
        <tr><td>Defend</td><td>Attack / Assault</td></tr>
        <tr><td>Deficient</td><td>Adequate / Sufficient</td></tr>
        <tr><td>Definite</td><td>Vague / Indefinite</td></tr>
        <tr><td>Defy</td><td>Obey / Submit</td></tr>
        <tr><td>Deliberate</td><td>Accidental / Unintentional</td></tr>
        <tr><td>Delicate</td><td>Tough / Robust</td></tr>
        <tr><td>Delight</td><td>Sorrow / Misery</td></tr>
        <tr><td>Demolish</td><td>Construct / Build</td></tr>
        <tr><td>Denounce</td><td>Praise / Commend</td></tr>
        <tr><td>Dense</td><td>Sparse / Thin</td></tr>
        <tr><td>Depart</td><td>Arrive / Return</td></tr>
        <tr><td>Deplete</td><td>Replenish / Restore</td></tr>
        <tr><td>Deprecate</td><td>Approve / Praise</td></tr>
        <tr><td>Deride</td><td>Praise / Honor</td></tr>
        <tr><td>Descend</td><td>Ascend / Rise</td></tr>
        <tr><td>Desolate</td><td>Inhabited / Lively</td></tr>
        <tr><td>Despair</td><td>Hope / Optimism</td></tr>
        <tr><td>Despise</td><td>Admire / Respect</td></tr>
        <tr><td>Destructive</td><td>Constructive / Beneficial</td></tr>
        <tr><td>Detrimental</td><td>Beneficial / Helpful</td></tr>
        <tr><td>Devious</td><td>Straightforward / Honest</td></tr>
        <tr><td>Devoted</td><td>Disloyal / Faithless</td></tr>
        <tr><td>Dexterous</td><td>Clumsy / Awkward</td></tr>
        <tr><td>Diffident</td><td>Confident / Bold</td></tr>
        <tr><td>Diligent</td><td>Lazy / Idle</td></tr>
        <tr><td>Diminish</td><td>Increase / Augment</td></tr>
        <tr><td>Disappear</td><td>Appear / Emerge</td></tr>
        <tr><td>Disclose</td><td>Conceal / Hide</td></tr>
        <tr><td>Disgrace</td><td>Honor / Respect</td></tr>
        <tr><td>Dismay</td><td>Encourage / Hearten</td></tr>
        <tr><td>Disperse</td><td>Gather / Assemble</td></tr>
        <tr><td>Dispose</td><td>Acquire / Retain</td></tr>
        <tr><td>Distort</td><td>Straighten / Accurate</td></tr>
        <tr><td>Divine</td><td>Mortal / Earthly</td></tr>
        <tr><td>Docile</td><td>Stubborn / Defiant</td></tr>
        <tr><td>Dogmatic</td><td>Open-minded / Flexible</td></tr>
        <tr><td>Dominant</td><td>Subordinate / Submissive</td></tr>
        <tr><td>Drab</td><td>Bright / Colorful</td></tr>
        <tr><td>Dread</td><td>Welcome / Anticipate eagerly</td></tr>
        <tr><td>Drowsy</td><td>Alert / Awake</td></tr>
        <tr><td>Dubious</td><td>Certain / Definite</td></tr>
        <tr><td>Dwindle</td><td>Increase / Grow</td></tr>
        <tr><td>Eager</td><td>Reluctant / Apathetic</td></tr>
        <tr><td>Ebb</td><td>Flow / Rise</td></tr>
        <tr><td>Eccentric</td><td>Normal / Conventional</td></tr>
        <tr><td>Eclipse</td><td>Reveal / Brighten</td></tr>
        <tr><td>Economical</td><td>Extravagant / Wasteful</td></tr>
        <tr><td>Effective</td><td>Ineffective / Useless</td></tr>
        <tr><td>Elated</td><td>Depressed / Sad</td></tr>
        <tr><td>Eligible</td><td>Ineligible / Disqualified</td></tr>
        <tr><td>Elude</td><td>Confront / Face</td></tr>
        <tr><td>Emaciated</td><td>Plump / Robust</td></tr>
        <tr><td>Emerge</td><td>Disappear / Vanish</td></tr>
        <tr><td>Emphasize</td><td>Downplay / Minimize</td></tr>
        <tr><td>Encourage</td><td>Discourage / Dissuade</td></tr>
        <tr><td>Endure</td><td>Surrender / Yield</td></tr>
        <tr><td>Enhance</td><td>Diminish / Reduce</td></tr>
        <tr><td>Enmity</td><td>Friendship / Amity</td></tr>
        <tr><td>Enormous</td><td>Tiny / Minuscule</td></tr>
        <tr><td>Entry</td><td>Exit / Departure</td></tr>
        <tr><td>Ephemeral</td><td>Eternal / Permanent</td></tr>
        <tr><td>Equilibrium</td><td>Imbalance / Disorder</td></tr>
        <tr><td>Eradicate</td><td>Plant / Establish</td></tr>
        <tr><td>Erratic</td><td>Consistent / Steady</td></tr>
        <tr><td>Eternal</td><td>Temporary / Transient</td></tr>
        <tr><td>Ethical</td><td>Unethical / Immoral</td></tr>
        <tr><td>Euphoria</td><td>Despair / Misery</td></tr>
        <tr><td>Evasive</td><td>Direct / Frank</td></tr>
        <tr><td>Exacerbate</td><td>Alleviate / Ease</td></tr>
        <tr><td>Exalt</td><td>Demean / Humble</td></tr>
        <tr><td>Exclude</td><td>Include / Comprise</td></tr>
        <tr><td>Excuse</td><td>Blame / Accuse</td></tr>
        <tr><td>Exempt</td><td>Subject / Liable</td></tr>
        <tr><td>Exhaust</td><td>Replenish / Refresh</td></tr>
        <tr><td>Exotic</td><td>Native / Common</td></tr>
        <tr><td>Expand</td><td>Contract / Shrink</td></tr>
        <tr><td>Expedite</td><td>Delay / Hinder</td></tr>
        <tr><td>Explicit</td><td>Implicit / Vague</td></tr>
        <tr><td>Exquisite</td><td>Ugly / Ordinary</td></tr>
        <tr><td>External</td><td>Internal / Inside</td></tr>
        <tr><td>Extinct</td><td>Living / Extant</td></tr>
        <tr><td>Extreme</td><td>Moderate / Mild</td></tr>
        <tr><td>Exuberant</td><td>Despondent / Subdued</td></tr>
        <tr><td>Fabricate</td><td>Truth-tell / Reveal</td></tr>
        <tr><td>Facile</td><td>Difficult / Profound</td></tr>
        <tr><td>Fade</td><td>Brighten / Strengthen</td></tr>
        <tr><td>Fallacy</td><td>Truth / Verity</td></tr>
        <tr><td>False</td><td>True / Real</td></tr>
        <tr><td>Familiar</td><td>Unfamiliar / Strange</td></tr>
        <tr><td>Famous</td><td>Obscure / Unknown</td></tr>
        <tr><td>Fanatical</td><td>Moderate / Reasonable</td></tr>
        <tr><td>Fatigued</td><td>Energetic / Refreshed</td></tr>
        <tr><td>Favorable</td><td>Unfavorable / Adverse</td></tr>
        <tr><td>Feeble</td><td>Strong / Robust</td></tr>
        <tr><td>Ferocious</td><td>Gentle / Mild</td></tr>
        <tr><td>Fertile</td><td>Barren / Sterile</td></tr>
        <tr><td>Fictitious</td><td>Real / Factual</td></tr>
        <tr><td>Fierce</td><td>Calm / Gentle</td></tr>
        <tr><td>Filthy</td><td>Clean / Spotless</td></tr>
        <tr><td>Flagrant</td><td>Subtle / Discreet</td></tr>
        <tr><td>Flamboyant</td><td>Plain / Modest</td></tr>
        <tr><td>Flatter</td><td>Insult / Criticize</td></tr>
        <tr><td>Flawed</td><td>Perfect / Flawless</td></tr>
        <tr><td>Flexible</td><td>Rigid / Inflexible</td></tr>
        <tr><td>Flourish</td><td>Wither / Decline</td></tr>
        <tr><td>Fluctuate</td><td>Remain steady</td></tr>
        <tr><td>Foe</td><td>Friend / Ally</td></tr>
        <tr><td>Foolish</td><td>Wise / Sensible</td></tr>
        <tr><td>Forbid</td><td>Permit / Allow</td></tr>
        <tr><td>Foreign</td><td>Native / Domestic</td></tr>
        <tr><td>Formidable</td><td>Manageable / Weak</td></tr>
        <tr><td>Forsake</td><td>Stay with / Maintain</td></tr>
        <tr><td>Foster</td><td>Hinder / Neglect</td></tr>
        <tr><td>Fragile</td><td>Sturdy / Durable</td></tr>
        <tr><td>Frank</td><td>Insincere / Evasive</td></tr>
        <tr><td>Frantic</td><td>Calm / Composed</td></tr>
        <tr><td>Frequent</td><td>Rare / Infrequent</td></tr>
        <tr><td>Frivolous</td><td>Serious / Important</td></tr>
        <tr><td>Frugal</td><td>Wasteful / Extravagant</td></tr>
        <tr><td>Furtive</td><td>Open / Candid</td></tr>
        <tr><td>Futile</td><td>Productive / Useful</td></tr>
        <tr><td>Garrulous</td><td>Reticent / Quiet</td></tr>
        <tr><td>Gather</td><td>Disperse / Scatter</td></tr>
        <tr><td>Generous</td><td>Stingy / Miserly</td></tr>
        <tr><td>Gentle</td><td>Rough / Harsh</td></tr>
        <tr><td>Genuine</td><td>Fake / Spurious</td></tr>
        <tr><td>Glory</td><td>Disgrace / Shame</td></tr>
        <tr><td>Glum</td><td>Cheerful / Joyful</td></tr>
        <tr><td>Gorgeous</td><td>Ugly / Hideous</td></tr>
        <tr><td>Gradual</td><td>Sudden / Abrupt</td></tr>
        <tr><td>Grand</td><td>Modest / Humble</td></tr>
        <tr><td>Gratify</td><td>Frustrate / Disappoint</td></tr>
        <tr><td>Grave</td><td>Trivial / Light</td></tr>
        <tr><td>Gregarious</td><td>Solitary / Antisocial</td></tr>
        <tr><td>Guilty</td><td>Innocent / Blameless</td></tr>
        <tr><td>Haphazard</td><td>Planned / Systematic</td></tr>
        <tr><td>Harmonious</td><td>Discordant / Clashing</td></tr>
        <tr><td>Harsh</td><td>Gentle / Mild</td></tr>
        <tr><td>Hasten</td><td>Delay / Slow</td></tr>
        <tr><td>Haughty</td><td>Humble / Modest</td></tr>
        <tr><td>Hazardous</td><td>Safe / Secure</td></tr>
        <tr><td>Heinous</td><td>Honourable / Decent</td></tr>
        <tr><td>Heretical</td><td>Orthodox / Conventional</td></tr>
        <tr><td>Hesitant</td><td>Confident / Decisive</td></tr>
        <tr><td>Hideous</td><td>Beautiful / Attractive</td></tr>
        <tr><td>Hinder</td><td>Help / Facilitate</td></tr>
        <tr><td>Hoist</td><td>Lower / Drop</td></tr>
        <tr><td>Hollow</td><td>Solid / Filled</td></tr>
        <tr><td>Honesty</td><td>Dishonesty / Deceit</td></tr>
        <tr><td>Horrid</td><td>Pleasant / Delightful</td></tr>
        <tr><td>Hostile</td><td>Friendly / Welcoming</td></tr>
        <tr><td>Humid</td><td>Dry / Arid</td></tr>
        <tr><td>Hypocritical</td><td>Sincere / Genuine</td></tr>
        <tr><td>Idealistic</td><td>Realistic / Pragmatic</td></tr>
        <tr><td>Idle</td><td>Active / Busy</td></tr>
        <tr><td>Ignorant</td><td>Knowledgeable / Learned</td></tr>
        <tr><td>Illegitimate</td><td>Legitimate / Lawful</td></tr>
        <tr><td>Imitate</td><td>Originate / Invent</td></tr>
        <tr><td>Impair</td><td>Improve / Enhance</td></tr>
        <tr><td>Impartial</td><td>Biased / Prejudiced</td></tr>
        <tr><td>Impatient</td><td>Patient / Calm</td></tr>
        <tr><td>Impede</td><td>Help / Facilitate</td></tr>
        <tr><td>Implicit</td><td>Explicit / Stated</td></tr>
        <tr><td>Imprison</td><td>Free / Release</td></tr>
        <tr><td>Improvise</td><td>Plan / Prepare</td></tr>
        <tr><td>Impulsive</td><td>Calculating / Deliberate</td></tr>
        <tr><td>Inadvertent</td><td>Intentional / Deliberate</td></tr>
        <tr><td>Inane</td><td>Sensible / Meaningful</td></tr>
        <tr><td>Inception</td><td>Conclusion / End</td></tr>
        <tr><td>Incessant</td><td>Intermittent / Periodic</td></tr>
        <tr><td>Inclined</td><td>Disinclined / Averse</td></tr>
        <tr><td>Incoherent</td><td>Coherent / Lucid</td></tr>
        <tr><td>Indolent</td><td>Industrious / Active</td></tr>
        <tr><td>Indifferent</td><td>Concerned / Interested</td></tr>
        <tr><td>Indignant</td><td>Pleased / Content</td></tr>
        <tr><td>Indulgent</td><td>Strict / Stern</td></tr>
        <tr><td>Inept</td><td>Skilful / Competent</td></tr>
        <tr><td>Inferior</td><td>Superior / Better</td></tr>
        <tr><td>Infrequent</td><td>Frequent / Common</td></tr>
        <tr><td>Innocent</td><td>Guilty / Culpable</td></tr>
        <tr><td>Insignificant</td><td>Significant / Important</td></tr>
        <tr><td>Intricate</td><td>Simple / Plain</td></tr>
        <tr><td>Intrepid</td><td>Cowardly / Timid</td></tr>
        <tr><td>Invincible</td><td>Vulnerable / Weak</td></tr>
        <tr><td>Irate</td><td>Calm / Pleased</td></tr>
        <tr><td>Lavish</td><td>Frugal / Sparing</td></tr>
        <tr><td>Lenient</td><td>Strict / Severe</td></tr>
        <tr><td>Lethargic</td><td>Energetic / Active</td></tr>
        <tr><td>Liability</td><td>Asset / Benefit</td></tr>
        <tr><td>Loquacious</td><td>Taciturn / Quiet</td></tr>
        <tr><td>Lucid</td><td>Obscure / Unclear</td></tr>
        <tr><td>Lure</td><td>Repel / Discourage</td></tr>
        <tr><td>Magnify</td><td>Diminish / Reduce</td></tr>
        <tr><td>Malice</td><td>Goodwill / Benevolence</td></tr>
        <tr><td>Massive</td><td>Tiny / Small</td></tr>
        <tr><td>Mature</td><td>Immature / Childish</td></tr>
        <tr><td>Meager</td><td>Abundant / Plentiful</td></tr>
        <tr><td>Mediocre</td><td>Excellent / Superior</td></tr>
        <tr><td>Melancholy</td><td>Cheerful / Joyous</td></tr>
        <tr><td>Menial</td><td>Skilled / Honourable</td></tr>
        <tr><td>Merciful</td><td>Merciless / Cruel</td></tr>
        <tr><td>Meticulous</td><td>Careless / Sloppy</td></tr>
        <tr><td>Mighty</td><td>Weak / Feeble</td></tr>
        <tr><td>Minute</td><td>Huge / Enormous</td></tr>
        <tr><td>Mitigate</td><td>Aggravate / Worsen</td></tr>
        <tr><td>Mock</td><td>Praise / Respect</td></tr>
        <tr><td>Modest</td><td>Boastful / Arrogant</td></tr>
        <tr><td>Monotonous</td><td>Varied / Interesting</td></tr>
        <tr><td>Morose</td><td>Cheerful / Jovial</td></tr>
        <tr><td>Mundane</td><td>Extraordinary / Special</td></tr>
        <tr><td>Munificent</td><td>Stingy / Miserly</td></tr>
        <tr><td>Mysterious</td><td>Obvious / Plain</td></tr>
        <tr><td>Naive</td><td>Worldly / Sophisticated</td></tr>
        <tr><td>Nascent</td><td>Mature / Established</td></tr>
        <tr><td>Nebulous</td><td>Clear / Definite</td></tr>
        <tr><td>Negligible</td><td>Significant / Substantial</td></tr>
        <tr><td>Nimble</td><td>Clumsy / Slow</td></tr>
        <tr><td>Noxious</td><td>Beneficial / Harmless</td></tr>
        <tr><td>Oblivious</td><td>Aware / Conscious</td></tr>
        <tr><td>Obscure</td><td>Clear / Famous</td></tr>
        <tr><td>Obsolete</td><td>Modern / Current</td></tr>
        <tr><td>Obstinate</td><td>Yielding / Flexible</td></tr>
        <tr><td>Ominous</td><td>Favorable / Promising</td></tr>
        <tr><td>Opaque</td><td>Transparent / Clear</td></tr>
        <tr><td>Opulent</td><td>Impoverished / Poor</td></tr>
        <tr><td>Orderly</td><td>Disorderly / Chaotic</td></tr>
        <tr><td>Orthodox</td><td>Unorthodox / Heretical</td></tr>
        <tr><td>Outgoing</td><td>Reserved / Introverted</td></tr>
        <tr><td>Pacify</td><td>Provoke / Agitate</td></tr>
        <tr><td>Palatable</td><td>Distasteful / Unpalatable</td></tr>
        <tr><td>Pallid</td><td>Ruddy / Healthy</td></tr>
        <tr><td>Paltry</td><td>Substantial / Significant</td></tr>
        <tr><td>Paramount</td><td>Trivial / Minor</td></tr>
        <tr><td>Parsimonious</td><td>Generous / Lavish</td></tr>
        <tr><td>Passive</td><td>Active / Energetic</td></tr>
        <tr><td>Patient</td><td>Impatient / Restless</td></tr>
        <tr><td>Pensive</td><td>Carefree / Blithe</td></tr>
        <tr><td>Perilous</td><td>Safe / Secure</td></tr>
        <tr><td>Perish</td><td>Survive / Live</td></tr>
        <tr><td>Permanent</td><td>Temporary / Transient</td></tr>
        <tr><td>Persistent</td><td>Inconsistent / Wavering</td></tr>
        <tr><td>Perturb</td><td>Calm / Compose</td></tr>
        <tr><td>Pessimistic</td><td>Optimistic / Hopeful</td></tr>
        <tr><td>Petulant</td><td>Cheerful / Good-humored</td></tr>
        <tr><td>Piety</td><td>Impiety / Irreverence</td></tr>
        <tr><td>Placid</td><td>Stormy / Agitated</td></tr>
        <tr><td>Plausible</td><td>Implausible / Unlikely</td></tr>
        <tr><td>Pleasant</td><td>Unpleasant / Disagreeable</td></tr>
        <tr><td>Polite</td><td>Rude / Impolite</td></tr>
        <tr><td>Ponderous</td><td>Light / Nimble</td></tr>
        <tr><td>Pragmatic</td><td>Idealistic / Impractical</td></tr>
        <tr><td>Precise</td><td>Vague / Inexact</td></tr>
        <tr><td>Premature</td><td>Mature / Timely</td></tr>
        <tr><td>Pretentious</td><td>Modest / Unaffected</td></tr>
        <tr><td>Prevent</td><td>Allow / Permit</td></tr>
        <tr><td>Pristine</td><td>Polluted / Spoiled</td></tr>
        <tr><td>Profound</td><td>Superficial / Shallow</td></tr>
        <tr><td>Prolific</td><td>Unproductive / Sterile</td></tr>
        <tr><td>Prosperous</td><td>Poor / Impoverished</td></tr>
        <tr><td>Provocative</td><td>Soothing / Calming</td></tr>
        <tr><td>Prudent</td><td>Imprudent / Reckless</td></tr>
        <tr><td>Punctual</td><td>Late / Tardy</td></tr>
        <tr><td>Quaint</td><td>Modern / Trendy</td></tr>
        <tr><td>Quell</td><td>Incite / Provoke</td></tr>
        <tr><td>Quiescent</td><td>Active / Restless</td></tr>
        <tr><td>Quirky</td><td>Normal / Conventional</td></tr>
        <tr><td>Rampant</td><td>Controlled / Restrained</td></tr>
        <tr><td>Random</td><td>Specific / Planned</td></tr>
        <tr><td>Raucous</td><td>Quiet / Peaceful</td></tr>
        <tr><td>Reckless</td><td>Cautious / Careful</td></tr>
        <tr><td>Recondite</td><td>Simple / Clear</td></tr>
        <tr><td>Refute</td><td>Confirm / Support</td></tr>
        <tr><td>Relevant</td><td>Irrelevant / Unrelated</td></tr>
        <tr><td>Reluctant</td><td>Willing / Eager</td></tr>
        <tr><td>Remarkable</td><td>Ordinary / Unremarkable</td></tr>
        <tr><td>Remote</td><td>Nearby / Close</td></tr>
        <tr><td>Renown</td><td>Obscurity / Anonymity</td></tr>
        <tr><td>Resilient</td><td>Brittle / Vulnerable</td></tr>
        <tr><td>Restrict</td><td>Allow / Liberate</td></tr>
        <tr><td>Reveal</td><td>Conceal / Hide</td></tr>
        <tr><td>Reverent</td><td>Irreverent / Disrespectful</td></tr>
        <tr><td>Rigid</td><td>Flexible / Pliable</td></tr>
        <tr><td>Rotund</td><td>Slim / Slender</td></tr>
        <tr><td>Rude</td><td>Polite / Courteous</td></tr>
        <tr><td>Ruthless</td><td>Merciful / Compassionate</td></tr>
        <tr><td>Sanguine</td><td>Pessimistic / Gloomy</td></tr>
        <tr><td>Savage</td><td>Civilized / Gentle</td></tr>
        <tr><td>Scarce</td><td>Plentiful / Abundant</td></tr>
        <tr><td>Scatter</td><td>Gather / Collect</td></tr>
        <tr><td>Scorn</td><td>Respect / Admiration</td></tr>
        <tr><td>Scrupulous</td><td>Unscrupulous / Dishonest</td></tr>
        <tr><td>Secular</td><td>Religious / Sacred</td></tr>
        <tr><td>Sensible</td><td>Foolish / Irrational</td></tr>
        <tr><td>Serene</td><td>Disturbed / Agitated</td></tr>
        <tr><td>Severe</td><td>Mild / Gentle</td></tr>
        <tr><td>Shallow</td><td>Deep / Profound</td></tr>
        <tr><td>Shrewd</td><td>Naive / Foolish</td></tr>
        <tr><td>Significant</td><td>Trivial / Minor</td></tr>
        <tr><td>Sincere</td><td>Insincere / False</td></tr>
        <tr><td>Sloppy</td><td>Tidy / Neat</td></tr>
        <tr><td>Sluggish</td><td>Brisk / Energetic</td></tr>
        <tr><td>Smug</td><td>Humble / Modest</td></tr>
        <tr><td>Solemn</td><td>Lighthearted / Cheerful</td></tr>
        <tr><td>Somber</td><td>Cheerful / Bright</td></tr>
        <tr><td>Sparse</td><td>Dense / Abundant</td></tr>
        <tr><td>Spontaneous</td><td>Planned / Deliberate</td></tr>
        <tr><td>Spurious</td><td>Genuine / Authentic</td></tr>
        <tr><td>Stable</td><td>Unstable / Wobbly</td></tr>
        <tr><td>Stagnant</td><td>Flowing / Active</td></tr>
        <tr><td>Staunch</td><td>Disloyal / Wavering</td></tr>
        <tr><td>Sterile</td><td>Fertile / Productive</td></tr>
        <tr><td>Stern</td><td>Lenient / Mild</td></tr>
        <tr><td>Stoic</td><td>Emotional / Expressive</td></tr>
        <tr><td>Strict</td><td>Lenient / Lax</td></tr>
        <tr><td>Stubborn</td><td>Compliant / Yielding</td></tr>
        <tr><td>Subdue</td><td>Encourage / Excite</td></tr>
        <tr><td>Submissive</td><td>Dominant / Defiant</td></tr>
        <tr><td>Subsequent</td><td>Previous / Prior</td></tr>
        <tr><td>Subtle</td><td>Obvious / Apparent</td></tr>
        <tr><td>Succinct</td><td>Verbose / Wordy</td></tr>
        <tr><td>Sufficient</td><td>Insufficient / Inadequate</td></tr>
        <tr><td>Superficial</td><td>Deep / Profound</td></tr>
        <tr><td>Suspect</td><td>Trust / Believe</td></tr>
        <tr><td>Sympathy</td><td>Apathy / Indifference</td></tr>
        <tr><td>Taciturn</td><td>Talkative / Garrulous</td></tr>
        <tr><td>Tame</td><td>Wild / Untamed</td></tr>
        <tr><td>Tedious</td><td>Exciting / Interesting</td></tr>
        <tr><td>Tenuous</td><td>Strong / Substantial</td></tr>
        <tr><td>Threatening</td><td>Reassuring / Soothing</td></tr>
        <tr><td>Thrifty</td><td>Wasteful / Extravagant</td></tr>
        <tr><td>Timid</td><td>Bold / Brave</td></tr>
        <tr><td>Tolerant</td><td>Intolerant / Bigoted</td></tr>
        <tr><td>Toxic</td><td>Safe / Harmless</td></tr>
        <tr><td>Tranquil</td><td>Turbulent / Stormy</td></tr>
        <tr><td>Transient</td><td>Permanent / Lasting</td></tr>
        <tr><td>Treacherous</td><td>Loyal / Faithful</td></tr>
        <tr><td>Trivial</td><td>Important / Significant</td></tr>
        <tr><td>Turbulent</td><td>Calm / Peaceful</td></tr>
        <tr><td>Tyrannical</td><td>Lenient / Benevolent</td></tr>
        <tr><td>Ubiquitous</td><td>Rare / Scarce</td></tr>
        <tr><td>Uncouth</td><td>Refined / Cultured</td></tr>
        <tr><td>Underestimate</td><td>Overestimate / Exaggerate</td></tr>
        <tr><td>Uniform</td><td>Varied / Diverse</td></tr>
        <tr><td>Unique</td><td>Common / Ordinary</td></tr>
        <tr><td>Vacant</td><td>Occupied / Full</td></tr>
        <tr><td>Vague</td><td>Specific / Clear</td></tr>
        <tr><td>Valiant</td><td>Cowardly / Timid</td></tr>
        <tr><td>Valid</td><td>Invalid / Void</td></tr>
        <tr><td>Vehement</td><td>Mild / Subdued</td></tr>
        <tr><td>Venerable</td><td>Disrespected / Dishonored</td></tr>
        <tr><td>Verbose</td><td>Concise / Terse</td></tr>
        <tr><td>Veteran</td><td>Novice / Beginner</td></tr>
        <tr><td>Viable</td><td>Unviable / Impractical</td></tr>
        <tr><td>Vibrant</td><td>Dull / Lifeless</td></tr>
        <tr><td>Vigilant</td><td>Negligent / Careless</td></tr>
        <tr><td>Vigor</td><td>Lethargy / Weakness</td></tr>
        <tr><td>Vile</td><td>Noble / Virtuous</td></tr>
        <tr><td>Vindicate</td><td>Blame / Accuse</td></tr>
        <tr><td>Virtuous</td><td>Wicked / Immoral</td></tr>
        <tr><td>Vivid</td><td>Dull / Faint</td></tr>
        <tr><td>Volatile</td><td>Stable / Steady</td></tr>
        <tr><td>Voluntary</td><td>Compulsory / Forced</td></tr>
        <tr><td>Voracious</td><td>Satisfied / Restrained</td></tr>
        <tr><td>Wane</td><td>Wax / Grow</td></tr>
        <tr><td>Wary</td><td>Careless / Reckless</td></tr>
        <tr><td>Wasteful</td><td>Frugal / Economical</td></tr>
        <tr><td>Wealthy</td><td>Poor / Destitute</td></tr>
        <tr><td>Weary</td><td>Energetic / Lively</td></tr>
        <tr><td>Whimsical</td><td>Serious / Practical</td></tr>
        <tr><td>Wicked</td><td>Virtuous / Good</td></tr>
        <tr><td>Witty</td><td>Dull / Boring</td></tr>
        <tr><td>Yielding</td><td>Stubborn / Inflexible</td></tr>
        <tr><td>Zealous</td><td>Apathetic / Indifferent</td></tr>
        <tr><td>Zenith</td><td>Nadir / Bottom</td></tr>
      </table>
      ...
      <ul>
        ...
        <li>For 45+ score: master all 400+ pairs; redo MCQs 3+ times.</li>
      </ul>
    `,
    mcq: [
